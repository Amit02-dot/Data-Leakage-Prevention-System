...
<nav class="top-nav">
    <div class="top-nav-brand">
        <div class="top-nav-logo" style="background: linear-gradient(135deg, #ef4444, #f59e0b);">D</div>
        <div>
            <div class="top-nav-title">DLPS Enterprise</div>
            <div class="top-nav-subtitle">Security Administration</div>
        </div>
    </div>
    
    <div class="top-nav-center">
        <div class="role-toggle">
            <button class="role-toggle-btn" onclick="alert('Please login as User to access User portal')">
...
<div id="logoutModal" style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.5); z-index: 9999; align-items: center; justify-content: center;">
    <div class="card" style="width: 400px; max-width: 90%; animation: slideIn 0.3s ease-out;">
        ...
        <div class="card-body text-center" style="padding: 1rem 0 2rem;">
            <div style="font-size: 3rem; color: var(--status-warning); margin-bottom: 1rem;">
        ...
        <div style="display: flex; gap: 1rem; justify-content: center;">
            ...
            <button class="btn btn-danger" onclick="window.location.href='/DLPs/api/auth/logout.php'">Yes, Logout</button>
        </div>
    </div>
</div>
